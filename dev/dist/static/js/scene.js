...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? module.exports = factory() : typeof define === 'function' && define.amd ? define(factory) : (global = global || self, global.Scene = factory());
})(void 0, function () {
  'use strict';
  /*! *****************************************************************************
  ...
  */
  ...
  var IS_WINDOW = (typeof window === "undefined" ? "undefined" : _typeof(window)) !== UNDEFINED;
  /**
  * Check whether the environment is window or node.js.
  * @memberof Consts
  * @name document
  ...
  */
  ...
  /*#__PURE__*/
  function getCrossBrowserProperty(property) {
    if (!doc) {
      return "";
    }
    ...
    if (_typeof(styles[property]) !== UNDEFINED) {
      return property;
    }
    ...
    for (var i = 0; i < length; ++i) {
      ...
      if (_typeof(styles[name]) !== UNDEFINED) {
        return name;
      }
    }
